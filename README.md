...
|--------|--------|-----|----------|
| **Week 9 (partial)** | 8 | **+$10.32** | 62.5% |
| Week 8 | 74 | **+$97.30** | 73.0% |
| **February (partial)** | 216 | **-$213.81** | 74.1% |
...
*Based on current performance with 310 days remaining*

*Last updated: 2026-02-24 15:22 UTC*
<!-- STATS_END -->
