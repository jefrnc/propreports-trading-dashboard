...
|--------|--------|-----|----------|
| **Week 8 (partial)** | 39 | **+$38.12** | 76.9% |
| Week 7 | 93 | **-$470.80** | 71.0% |
| **February (partial)** | 173 | **-$281.68** | 75.7% |
...
*Based on current performance with 314 days remaining*

*Last updated: 2026-02-20 03:51 UTC*
<!-- STATS_END -->
