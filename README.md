...
|--------|--------|-----|----------|
| **Week 7 (partial)** | 60 | **-$169.31** | 73.3% |
| Week 6 | 41 | **+$153.05** | 85.4% |
| **February (partial)** | 101 | **-$12.43** | 78.2% |
...
*Based on current performance with 320 days remaining*

*Last updated: 2026-02-14 03:49 UTC*
<!-- STATS_END -->
