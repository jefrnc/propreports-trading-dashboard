...
|--------|--------|-----|----------|
| **Week 5 (partial)** | 21 | **+$92.21** | 85.7% |
| Week 4 | 40 | **-$202.66** | 52.5% |
| **January (partial)** | 213 | **+$220.46** | 68.5% |
...
*Based on current performance with 337 days remaining*

*Last updated: 2026-01-28 15:12 UTC*
<!-- STATS_END -->
