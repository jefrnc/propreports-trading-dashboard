...
|--------|--------|-----|----------|
| **Week 9 (partial)** | 27 | **+$9.72** | 63.0% |
| Week 8 | 74 | **+$97.30** | 73.0% |
| **February (partial)** | 235 | **-$214.41** | 73.2% |
...
*Based on current performance with 308 days remaining*

*Last updated: 2026-02-26 03:51 UTC*
<!-- STATS_END -->
