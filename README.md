...
|--------|------------|---------------|
| **Trades** | 1,710 | 2,026 |
| **P&L** | **-$1,088.51** | **-$1,289.96** |

*Based on current performance with 57 days remaining*

*Last updated: 2025-11-04 03:25 UTC*
<!-- STATS_END -->
